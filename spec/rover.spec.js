...
//Test 12
it("12 responds with false completed value when attempting to move in LOW_POWER mode", function(){    
...
let commands = [/*new Command('MODE_CHANGE', 'NORMAL'),*/new Command('MOVE', 50000000)];
  
let message = new Message('Test  "MOVE" command to return new position', commands);
  
it("13 responds with position for move command", function(){
let rover = new Rover(89898989);
